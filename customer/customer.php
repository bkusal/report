...
<main class="form-signin w-100 m-auto">
  <form action="customer_process.php" method="POST">
    <h1 class="h3 mb-3 fw-normal">Add Customer</h1>
    ...
    <div class="form-floating mb-3">
      <textarea name="descriotion" id="" cols="40" rows="10" placeholder="About Customer"></textarea>
    </div>
  
   
    <button class="btn btn-primary w-100 py-2" type="submit" name="Hand">Submit</button>
